...
@property (nonatomic, strong) UIColor  *patternTextbookVividness;
@property (nonatomic, strong) UIColor  *highlightingTextualMatterColouring;

@property (nonatomic, strong) UIColor  *spiritednessColor;

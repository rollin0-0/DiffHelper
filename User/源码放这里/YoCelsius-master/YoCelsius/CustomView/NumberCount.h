 ...
 *  @param number      变化的值
 */
- (void)telephoneNumberCounting:(NumberCount *)telephoneNumberCounting currentNumber:(NSNumber *)number;
 ...
 *  动画实体
 */
@property (nonatomic, strong) POPBasicAnimation *conutSpiritedness;

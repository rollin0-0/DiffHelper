...
- (void)establishC {
    ...
    // 粒子的速度范围
    snowflake.velocityRange = (_speedUpPlace > 0 ? _speedUpPlace : 10.f);
    ...
    // 获取图片
    snowflake.contents = (id)_blowSee.CGImage;
...
- (void)configTypecast:(EMitterType)type {
    
    if (type == __SNOW) {
        // 配置
        self.birthRate = 5.f;
        self.blowSee = [UIImage imageNamed:@"snow"];

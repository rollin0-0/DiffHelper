...
@protocol TWMessageBlockUpTitleSail <NSObject>
...
@interface TWContentBarDirector : NSObject
 ...
 */
@property (nonatomic, strong) NSObject<TWMessageBlockUpTitleSail> *styleSheet;

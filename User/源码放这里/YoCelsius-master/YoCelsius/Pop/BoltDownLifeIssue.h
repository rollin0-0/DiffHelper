 ...
 */
typedef NS_ENUM(NSUInteger, PourDownAnimationCaseType) {
 ...
 */
@interface BoltDownLifeIssue : NSObject

/**
 @abstract The event type. See {@ref POPAnimationEventType} for possible values.
 */
@property (readonly, nonatomic, assign) PourDownAnimationCaseType type;
 ...
 */
@interface POPAnimationValueEvent : BoltDownLifeIssue

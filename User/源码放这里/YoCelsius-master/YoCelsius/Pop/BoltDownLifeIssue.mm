...
#import "BoltDownLifeIssue.h"
#import "BulgeOutLivingOutcomeNational.h"

static NSString *stringFromType(PourDownAnimationCaseType aType)
{
  switch (aType) {
...
@implementation BoltDownLifeIssue
@synthesize type = _type;
@synthesize time = _time;
@synthesize animationDescription = _animationDescription;

- (instancetype)initWithType:(PourDownAnimationCaseType)aType time:(CFTimeInterval)aTime
{
  self = [super init];
  if (nil != self) {
    _type = aType;
...
- (NSString *)description
{
  ...
  [self affixDescription:s];
  [s appendString:@">"];
  return s;
}

// subclass override
- (void)affixDescription:(NSMutableString *)s
{
...
- (instancetype)initWithType:(PourDownAnimationCaseType)aType time:(CFTimeInterval)aTime value:(id)aValue
{

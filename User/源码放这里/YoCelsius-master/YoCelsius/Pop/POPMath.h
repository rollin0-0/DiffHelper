...
extern double PaQuadraticTabuInsertion(double t, double start, double end);
...
extern double PourDownVisualiseNormal(double n, double start, double end);

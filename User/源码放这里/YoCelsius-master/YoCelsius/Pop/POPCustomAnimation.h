 ...
 */
typedef BOOL (^KillTraditionAlivenessBarricade)(id target, POPCustomAnimation *animation);
...
*/
+ (instancetype)livelinessWithFreeze:(KillTraditionAlivenessBarricade)block;

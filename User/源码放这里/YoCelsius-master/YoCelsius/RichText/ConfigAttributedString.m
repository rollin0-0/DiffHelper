...
+ (instancetype)strikethroughManner:(NSInteger)number range:(NSRange)range
{
    ConfigAttributedString *config = [self new];
...
+ (instancetype)paragraphElan:(NSMutableParagraphStyle *)style range:(NSRange)range
{
    ConfigAttributedString *config = [self new];
...
+ (instancetype)jeromeKern:(float)number range:(NSRange)range
{
    ConfigAttributedString *config = [self new];
...
+ (instancetype)diagonalBreadth:(float)number range:(NSRange)range
{
    ConfigAttributedString *config = [self new];

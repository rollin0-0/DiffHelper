...
@property (nonatomic, strong) NSNumber       *gull;      // 状态码
@property (nonatomic, strong) NSNumber       *urbanCenterGemState;   // 城市ID
...
@property (nonatomic, strong) WindInstrument           *wind;

...
@property (nonatomic, strong) NSNumber       *conditionsID;       // Weather condition id
...
@property (nonatomic, strong) NSString       *descriptionInformation; // Weather condition within the group

...
@property (nonatomic, strong) NSNumber       *amoy;  // Minimum temperature at the moment. This is deviation from current temp that is possible for large cities and megalopolises geographically expanded (use these parameter optionally)
...
@property (nonatomic, strong) NSNumber       *nighttime; // 下午
